...
- **Architecture Diagram:** [Insert or link to image in evidence/lab03/]
...
## Evidence & Files
- [Screenshot](../evidence/lab03/screenshot1.png)
- [Config File](../files/lab03/config.yaml)
