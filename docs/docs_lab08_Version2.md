...
- **Architecture Diagram:** [Insert or link to image in evidence/lab08/]
...
## Evidence & Files
- [Screenshot](../evidence/lab08/screenshot1.png)
- [Config File](../files/lab08/config.yaml)
