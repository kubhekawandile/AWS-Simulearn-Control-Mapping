...
- **Architecture Diagram:** [Insert or link to image in evidence/lab06/]
...
## Evidence & Files
- [Screenshot](../evidence/lab06/screenshot1.png)
- [Config File](../files/lab06/config.yaml)
