...
- **Architecture Diagram:** [Insert or link to image in evidence/lab05/]
...
## Evidence & Files
- [Screenshot](../evidence/lab05/screenshot1.png)
- [Config File](../files/lab05/config.yaml)
