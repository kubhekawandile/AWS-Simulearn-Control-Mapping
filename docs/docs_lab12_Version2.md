...
- **Architecture Diagram:** [Insert or link to image in evidence/lab12/]
...
## Evidence & Files
- [Screenshot](../evidence/lab12/screenshot1.png)
- [Config File](../files/lab12/config.yaml)
