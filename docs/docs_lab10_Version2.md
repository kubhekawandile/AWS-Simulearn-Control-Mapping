...
- **Architecture Diagram:** [Insert or link to image in evidence/lab10/]
...
## Evidence & Files
- [Screenshot](../evidence/lab10/screenshot1.png)
- [Config File](../files/lab10/config.yaml)
